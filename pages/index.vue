<!-- pages/index.vue - SOLO CAMBIOS EN STYLE -->
<template>
  ...
  <!-- Sección de análisis - AGREGAR CLASE content-wrapper -->
  <div class="content-wrapper analyze-section">
    <h2 class="analyze-title">
      Análisis de Panic Log
    </h2>

    <!-- DROPZONE - ESTÁ AQUÍ, NO SE ELIMINA -->
  ...
  <!-- Sección de donaciones - AGREGAR CLASE content-wrapper -->
...
<style scoped>
/* SOLO ESTOS ESTILOS CAMBIAN - EL RESTO IGUAL */

/* Matrix Rain - z-index más bajo */
.matrix-rain {
  position: fixed;
  top: 0;
  left: 0;
  ...
  height: 100%;
  pointer-events: none;
  z-index: 1; /* CAMBIADO: era 0, ahora 1 */
  overflow: hidden;
}

/* NUEVO: Wrapper para contenido */
.content-wrapper {
  position: relative;
  z-index: 10; /* Por encima del matrix */
}
...
/* Matrix Rain Effect - ESTILOS ORIGINALES CON z-index CORREGIDO */
.matrix-column {
  position: absolute;
  top: -100%;
  width: 10px;
